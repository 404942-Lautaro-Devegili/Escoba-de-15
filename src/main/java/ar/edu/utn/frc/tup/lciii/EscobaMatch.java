...
public class EscobaMatch {
    ...
    public Boolean isFinish() {
        ...
        if (humanUserPoints >= 15 && humanUserPoints > appUserPoints) {
            winner = humanUser;
            print("The player " + humanUser.getName() + " won with " + humanUserPoints + "points.");
            return true;
        } else if (appUserPoints >= 15 && appUserPoints > humanUserPoints) {
            winner = appUser;
            print("The player " + appUser.getName() + " won with " + appUserPoints + "points.");
            return true;
        } else {
            ...
            print("The game is not over yet.\n" +
                  "The player " + humanUser.getName() + " has " + humanUserPoints + "points.\n" +
                  "The player " + appUser.getName() + " has " + appUserPoints + "points.");
            return false;
        }
    }
